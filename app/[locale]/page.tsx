...
const Page: React.FC<{ params: { locale: string } }> = ({
  ...
  return (
    <>
      ...
      <main>
        <div className="relative mb-[40px] mlarge:mb-[30px] mmedium:mb-[20px] py-[20px] mlarge:py-[10px] px-[30px] mlarge:px-[15px] w-full h-[400px] mlarge:h-[300px] mmedium:h-[250px] msmall:h-[200px] bg-[url('/static/MainPageBanner.webp')] mlarge:bg-[url('/static/HelldiversMobileBackgroundImage.png')] bg-no-repeat bg-cover border-2 border-[--color-theme] rounded-[10px]">
          <h1 className="text-[#ffffff] text-[3rem] mlarge:text-[2rem] mmedium:text-[1.75rem] msmall:text-[1.5rem] font-['Insignia'] font-bold brightness-125">
            HELLDIVERS
            <b className="text-[--color-theme] font-bold">.HELP</b>
          </h1>
        ...
        <div className="flex items-center gap-x-[30px] w-full h-auto">
