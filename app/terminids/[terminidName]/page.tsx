...
const Page = () => {
  ...
  const [currentTerminid, setCurrentTerminid] = useState({} as Enemy);

  useEffect(() => {
    const currentTerminidId = +queryParams.get("id")!;

    setCurrentTerminid(enemyTypeStore.terminids[currentTerminidId - 1]);
  }, []);
  return (
    <>
      <TheHeader />
