  ...
  achievements: { [key: string]: Achievement[] } = {
    easy: [
      ...
      },
      {
        ...
        accomplishmentWay:
          "Экипируйте броню со свойством «Демократия защищает» и постарайтесь взорваться. Возможно с 1 попытки не получится, но Адские Десантники не умирают!",
      },
      {
        id: 20,
    ...
    extreme: [
      ...
      },
      {
        ...
        description:
          "Эвакуируйте командус задания имея не менее чем 15 редкими образцами.",
        accomplishmentWay:
          "Просто идите на задание с более высоким уровнем сложности, так как там будет больше образцов.",
      },
      {
        id: 7,
