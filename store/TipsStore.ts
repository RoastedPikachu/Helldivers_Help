...
class TipsStore {
  ...
  tips = [
    ...
    {
      id: 30,
      text: "Вы на задании в одиночестве и нуждаетесь в освободительном подкреплении? Используйте аварийный маячок, чтобы призвать товарищей по Адскому Десанту.",
    },
    {
      id: 31,
    ...
    {
      id: 75,
      text: "Программа обучения Адского Десанта абсолютно безупречна, однако вы в любой момент можете пройти ее заново из меню игры.",
    },
    {
      id: 76,
      text: "Когда отведенное на задание время выйдет, суперэсминец покинет низкую орбиту и вы потеряете доступ к стратагемам и подкреплениям.",
    },
    {
      id: 77,
      text: "Министерство распространения не покладая рук работает над расширением влияния Свободы и захватывает необходимые для процветания нашего общества ресурсы.",
    },
    {
      id: 78,
      text: "Министерство правды отвечает за информирование и психическое здоровье граждан, позволяя противостоять гнусной пропаганде врагов.",
    },
    {
      id: 79,
      text: "Министерство гуманизма поддерживает здоровье и продуктивность избирателей, управляя сферами образования, здравоохранения, социальной оценки и генной инженерии.",
    },
    {
      id: 80,
      text: "Не забывайте подбирать контейнеры с образцами, оставшиеся после ваших павших товарищей. Они крайне важны для продвижения нашей науки!.",
    },
  ] as Tip[];
