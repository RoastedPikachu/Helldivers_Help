...
class WeaponsStore {
  ...
  primaryWeapons = [
    ...
    },
    {
      ...
      description:
        "Модифицированная винтовка «Освободитель», стреляющая контузящими боеприпасами. Наносит меньше урона, но ошеломляет врагов.",
      price: 20,
      damage: 65,
      magsCount: 10,
      roundsPerMag: 30,
    ...
    },
    {
      ...
      weaponType: weaponTypes.primary,
      name: "Штурмовая винтовка StA-52",
      description:
        "Штурмовая винтовка с вместительным барабанным магазином. Хорошо подходит для ведения непрерывного огня. Произведено «Оружием Шталя»",
      price: 20,
      damage: 70,
      magsCount: 8,
      roundsPerMag: 56,
    ...
    },
    {
      ...
      weaponType: weaponTypes.primary,
      name: "R-2124 «Конституция»",
      description:
        "Церемониальная винтовка, вдохновленная древними образцами оружия додемократических времен. По традиции каждый гражданин получает ее в подарок на шестнадцатилетие — как мотивацию пойти на службу.",
      price: 0,
      damage: 180,
      magsCount: 8,
      roundsPerMag: 5,
    ...
    },
    {
      ...
      weaponType: weaponTypes.primary,
      name: "Акселераторная винтовка PLAS-39",
      description:
        "Высокоточная плазменная винтовка, стреляющая очередями. Чтобы вести огонь, нужно накопить заряд.",
      price: 0,
      damage: 350,
      magsCount: 6,
      roundsPerMag: 9,
    ...
    },
    {
      ...
      name: "StA-11 «Рыцарь»",
      description:
        "Пистолет-пулемет со шнековым магазином, который обеспечивает оружие увеличенным боезапасом, но при этом утяжеляет его. Произведено «Оружием Шталя».",
      price: 0,
      damage: 65,
      magsCount: 7,
      roundsPerMag: 48,
    ...
    },
    {
      ...
      name: "SG-451 «Барбекю»",
      description:
        "Помповый дробовик, стреляющий зажигательной фосфорной дробью.",
      price: 60,
      damage: 320,
      magsCount: 3.75,
      roundsPerMag: 16,
    ...
    },
    {
      ...
      description:
        "Однозарядная винтовка, стреляющая реактивными снарядами, которые при ударе взрываются, разбрасывая вокруг осколки. Не рекомендуется для использования в ближнем бою.",
      price: 60,
      damage: 420,
      magsCount: 6,
      roundsPerMag: 5,
    ...
    },
    {
      ...
      weaponType: weaponTypes.primary,
      name: "FLAM-66 «Сжигатель»",
      description:
        "Легкий огнемет. Выбрасывает топливо под давлением через форсунку и поджигает его. Полностью безопасен.",
      price: 80,
      damage: 375,
      magsCount: 1,
      roundsPerMag: 80,
  ...
  secondaryWeapons = [
    ...
    },
    {
      ...
      name: "P-4 «Сенатор»",
      description:
        "Мощный револьвер, который можно перезаряжать по одному патрону. Надежное оружие, наносящее большой урон.",
      price: 15,
      damage: 175,
      magsCount: 3.33,
      roundsPerMag: 6,
    ...
    },
    {
      ...
      weaponType: weaponTypes.secondary,
      name: "P-11 Стим-пистолет",
      description:
        "Стреляет баллистическим дротиком почти со скоростью звука, позволяя применять стимы на расстоянии. Будет больно.",
      price: 5,
      damage: 0,
      magsCount: 4,
      roundsPerMag: 6,
    ...
    },
    {
      ...
      weaponType: weaponTypes.secondary,
      name: "CQC-19 Оглушающее копье",
      description:
        "Оружие ближнего боя, оснащенное электрозубцами. Способно ненадолго оглушать цели. Можно использовать как одноручное оружие.",
      price: 45,
      damage: 405,
      magsCount: 8,
      roundsPerMag: 3,
    ...
    },
    {
      ...
      weaponType: weaponTypes.secondary,
      name: "CQC-30 Оглушающая дубинка",
      description:
        "Легкое оружие ближнего боя. Способно ненадолго оглушать цели.",
      price: 45,
      damage: 405,
      magsCount: 8,
      roundsPerMag: 3,
  ...
  grenades = [
    ...
    },
    {
      ...
      name: "G-4 Газовая",
      description:
        "Граната, выпускающая облако ядовитого газа, который на время ослепляет и замедляет как органических, так и неорганических врагов.",
      price: 25,
      damage: 3,
      fuseTime: 2.9,
      penetration: 6,
    ...
    },
    {
      ...
      weaponType: weaponTypes.grenade,
      name: "K-2 Метательный нож",
      description: "Бесшумно доставляет правосудие врагам Свободы.",
      price: 15,
      damage: 250,
      fuseTime: 2.9,
      penetration: 3,
