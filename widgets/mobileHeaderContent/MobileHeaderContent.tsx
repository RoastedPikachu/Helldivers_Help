...
const MobileHeaderContent = () => {
  ...
  return (
    <header>
      ...
      <div
        className={`fixed w-full bg-[#01212f] duration-[400ms] ease-in-out overflow-y-scroll overscroll-contain z-40 ${window.location.href.includes("/stratagemTraining") ? "top-[65px] pb-[50px] h-[calc(100vh-80px)]" : "top-[115px] msmall:top-[110px] pb-[50px] h-[calc(100vh-115px)] msmall:h-[calc(100vh-110px)]"} ${isAdditionalHeaderInfoOpened ? "left-0" : "left-[-100vw]"}`}
      >
