      ...
      >
        <div className="flex items-center gap-x-[17px] mx-auto w-[1000px] h-[540px]">
          <div className="flex flex-wrap gap-x-[17px] gap-y-[17px] w-[401px] h-full">
            <WarbondItem width={192} height={351} price={2} />

            <WarbondItem width={192} height={351} price={15} />
          ...
          <div className="flex flex-wrap gap-x-[17px] gap-y-[17px] w-[610px] h-full">
            <div className="flex gap-x-[17px] w-full">
              <WarbondItem width={192} height={172} price={7} />
        ...
        <div className="flex items-center gap-x-[17px] mx-auto w-[1000px] h-[540px]">
          <div className="flex gap-x-[17px] gap-y-[17px] w-[401px] h-full">
            <div className="grid gap-y-[17px] w-[192px] h-full">
              <WarbondItem width={192} height={172} price={15} />

              <WarbondItem width={192} height={351} price={5} />
            </div>

            <div className="grid gap-y-[17px] w-[192px] h-full">
              <WarbondItem width={192} height={351} price={25} />

              <WarbondItem width={192} height={172} price={16} />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-x-[17px] gap-y-[17px] w-[610px] h-full">
            ...
            <div className="grid gap-y-[17px] h-auto">
              ...
              <WarbondItem width={192} height={167} price={16} />
            </div>

            <div className="flex gap-x-[17px] w-full">
              <WarbondItem width={192} height={172} price={12} />
        ...
        <div className="flex items-center gap-x-[17px] mx-auto w-[1000px] h-[540px]">
          <div className="flex flex-wrap gap-x-[17px] gap-y-[17px] w-[401px] h-full">
            <WarbondItem width={192} height={351} price={16} />

            <WarbondItem width={192} height={351} price={75} />
          ...
          <div className="flex flex-wrap gap-x-[17px] gap-y-[17px] w-[610px] h-full">
            <div className="flex gap-x-[17px] w-full">
              <WarbondItem width={192} height={172} price={32} />
